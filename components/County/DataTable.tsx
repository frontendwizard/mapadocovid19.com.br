...
const DataTable: React.FC<{ cities: any }> = ({ cities }) => {
  ...
  const columns = useMemo(
    () => [
      { Header: 'cidade', accessor: 'city' },
      {
        ...
        accessor: function Confirmed({ last_available_confirmed: confirmed }) {
          return (
            <>
      ...
      },
      {
        ...
        accessor: function Deaths({ last_available_deaths: deaths }) {
          return (
            <>
